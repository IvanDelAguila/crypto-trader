...
//
// createStore(fileName) permite tener pools de capital totalmente independientes
// (ej. el bot principal en trading.json y un motor de prueba en otro archivo),
// cada uno con su propio estado/posiciones/trades sin pisarse entre sí.
...
const defaultStore = createStore("trading.json");
